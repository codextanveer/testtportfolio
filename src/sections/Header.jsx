...
function Header() {
useEffect(() => {
  const circle = document.getElementById("animated-mouse-circle");

  let mouseX = 0;
  let mouseY = 0;

  // Update mouse position and move circle
  const moveCursor = (e) => {
    mouseX = e.clientX;
    mouseY = e.clientY;
    ...
    circle.style.transform = `translate(${mouseX - width / 2}px, ${mouseY - height / 2}px)`;
  };

  window.addEventListener("mousemove", moveCursor);

  const headerMain = document.querySelector(".header_menu");
  const heroContent = document.querySelector(".hero-content, .about-content");
  ...
  const shrinkCircle = () => {
    ...
    circle.style.transform = `translate(${mouseX - 0 / 2}px, ${mouseY - 0 / 2}px)`;
  };
  ...
  headerMain.addEventListener("mouseenter", shrinkCircle);
  headerMain.addEventListener("mouseleave", resetCircle);
  heroContent.addEventListener("mouseenter", bigCircle);
  heroContent.addEventListener("mouseleave", resetCircle);

  // Magnetic links
  const magnets = document.querySelectorAll(".link-logo, .social_link");
  ...
  const moveMagnet = (e) => {
    ...
    el.style.transform = `translate(${x * 0.7}px, ${y * 0.7}px)`;
  };
  ...
  return () => {
    ...
    headerMain.removeEventListener("mouseenter", shrinkCircle);
    headerMain.removeEventListener("mouseleave", resetCircle);
    heroContent.removeEventListener("mouseenter", bigCircle);
    heroContent.removeEventListener("mouseleave", resetCircle);
    magnets.forEach((el) => {
  ...
  return (
    <div>
      <div className="header">
        <div className="animated-mouse" id="animated-mouse-circle"></div>
            ...
            <div className="header-left">
              ...
              <div className="herder-bottem">
                <ul className="footer_socials ul__reset">
                  ...
                  <li className="social js-social">
                    <a className="social_link social_link__youtube" href="#">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <li className="social js-social">
                    <a className="social_link social_link__linkedin" href="#">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
